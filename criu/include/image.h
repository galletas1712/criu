...
extern int open_image_lazy(struct cr_img *img);
extern bool compact_pages_committed(int dfd, u32 pages_id);
extern bool compact_pages_usable(int dfd, u32 pages_id);
extern int clear_compact_pages_commit(int dfd);
